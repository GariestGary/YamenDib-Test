...
namespace BeauRoutine
{
    public partial struct Routine
    {
        ...
        /// <summary>
        /// Runs a manual routine
        /// </summary>
        static public Routine StartManual(IEnumerator inCoroutine)
        {
            return Start(inCoroutine).SetPhase(RoutinePhase.Manual);
        }

        /// <summary>
        /// Runs a manual routine
        /// </summary>
        static public Routine StartManual(MonoBehaviour inHost, IEnumerator inCoroutine)
        {
            return Start(inHost, inCoroutine).SetPhase(RoutinePhase.Manual);
        }
